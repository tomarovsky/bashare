...
bcftools query -l $PREFIX.filt.mask.vcf.gz | parallel -j 64 '
    SAMPLE={}
    echo "Sample: ${SAMPLE}"
    $TOOLS/MACE/scripts/draw_variant_window_densities.py -i ${SAMPLE}.$PREFIX.filt.mask.snp.hetero.vcf.gz -o ${SAMPLE}.$PREFIX.filt.mask.snp.hetero.w1mb.s100kb -l "HeteroSNP densities for ${SAMPLE}" -w 1000000 -s 100000 --scaffold_white_list $ASSEMBLY/*d.whitelist -z $ASSEMBLY/*d.orderedlist --scaffold_length_file $ASSEMBLY/*d.len --scaffold_syn_file $ASSEMBLY/*d.syn --syn_file_key_column 0 --syn_file_value_column 1 --hide_track_label --density_thresholds 0,0.1,0.5,1,2,3,4,5,6,7 --rounded --subplots_adjust_left 0.2 --centromere_bed $ASSEMBLY/*.centromere.bed

    $TOOLS/MACE/scripts/draw_variant_window_densities.py -i ${SAMPLE}.$PREFIX.filt.mask.snp.homo.vcf.gz -o ${SAMPLE}.$PREFIX.filt.mask.snp.homo.w1mb.s100kb -l "HomoSNP densities for ${SAMPLE}" -w 1000000 -s 100000 --scaffold_white_list $ASSEMBLY/*d.whitelist -z $ASSEMBLY/*d.orderedlist --scaffold_length_file $ASSEMBLY/*d.len --scaffold_syn_file $ASSEMBLY/*d.syn --syn_file_key_column 0 --syn_file_value_column 1 --hide_track_label --density_thresholds 0,0.1,0.5,1,2,3,4,5,6,7 --rounded --subplots_adjust_left 0.2 --centromere_bed $ASSEMBLY/*.centromere.bed

    $TOOLS/MACE/scripts/draw_variant_window_densities.py -i ${SAMPLE}.$PREFIX.filt.mask.snp.hetero.vcf.gz -o ${SAMPLE}.$PREFIX.filt.mask.snp.hetero.w100kb.s10kb -w 100000 -s 10000 -a $ASSEMBLY/*d.whitelist -z $ASSEMBLY/*d.orderedlist --scaffold_length_file $ASSEMBLY/*d.len --scaffold_syn_file $ASSEMBLY/*d.syn --syn_file_key_column 0 --syn_file_value_column 1 --only_count
    ...
    $TOOLS/MACE/scripts/draw_features.py -i ROH/${SAMPLE}.$PREFIX.filt.mask.snp.hetero.w1mb.s100kb.features.roh -o ROH/${SAMPLE}.$PREFIX.filt.mask.snp.hetero.w1mb.s100kb.features -t bed -l "ROHs for ${SAMPLE}" --scaffold_ordered_list $ASSEMBLY/*d.orderedlist --scaffold_length_file $ASSEMBLY/*d.len --scaffold_syn_file $ASSEMBLY/*d.syn --hide_track_label --rounded --subplots_adjust_left 0.2 --figure_width 10 --default_color "tab:blue" --centromere_bed $ASSEMBLY/*.centromere.bed
    ...
    $TOOLS/MACE/scripts/draw_features.py -i ROH/${SAMPLE}.$PREFIX.filt.mask.snp.hetero.w100kb.s10kb.features.roh -o ROH/${SAMPLE}.$PREFIX.filt.mask.snp.hetero.w100kb.s10kb.features -t bed -l "ROHs for ${SAMPLE}" --scaffold_ordered_list $ASSEMBLY/*d.orderedlist --scaffold_length_file $ASSEMBLY/*d.len --scaffold_syn_file $ASSEMBLY/*d.syn --hide_track_label --rounded --subplots_adjust_left 0.2 --figure_width 10  --default_color "tab:blue" --centromere_bed $ASSEMBLY/*.centromere.bed
'
